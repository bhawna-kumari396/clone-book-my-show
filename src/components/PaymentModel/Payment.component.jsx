...
export default function PaymentModal({ isOpen, setIsOpen, price }) {
  ...
  const launchRazorPay = () => {
    let options = {
      key: "rzp_test_Jntu1wReweFPR3",
      amount: price * 100,
      currency: "INR",
      name: "Book My Show Clone",
      discription: "Movie Purchase or rental",
      image:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRb_leudBdCOLwrskaZ4pWDmiQHMJkTPXQBKZhi5fRkQc6pqyAr87K7FPQCDw0gbYfv-R8&usqp=CAU",
      handler: () => {
        setIsOpen(false);
        alert("Payment Done")
      },
