    ...
    <>
      <div className="flex flex-col gap-3 lg:gap-8">
        <div className="flex items-center gap-4 md:px-4">
          ...
          <span className="bg-bms-700 p-2 text-xs text-white rounded-md">
            Streaming Now
          </span>
        </div>
        <h1 className="text-white lg:text-4xl font-bold hidden lg:block">Proximity</h1>
        <div className="flex flex-col-reverse gap-3 lg:gap-5 lg:flex-col">
          <div className="text-white font-light flex flex-col gap-2 md:px-4">
            <h4>4k &bull; English &bull; Languages: Audio(1), Subtitles(1)</h4>
            <h4>1h 53m &bull; Drama, Sci-fi</h4>
          </div>
